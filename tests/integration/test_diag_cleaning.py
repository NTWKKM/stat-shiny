...
import pandas as pd
import numpy as np
from utils.diag_test import calculate_chi2, analyze_roc, calculate_descriptive
...
def test_chi2_pipeline_integration():
    ...
    tab, stats_df, msg, risk_df, missing_info = calculate_chi2(
        ...
        col1="exposure",
        col2="outcome",
        var_meta={"exposure": {"type": "categorical"}, "outcome": {"type": "categorical"}}
    )
