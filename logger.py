...
class PerformanceLogger:
    ...
    @contextmanager
    def track_time(self, operation: str, log_level: str = "DEBUG") -> Generator[None, None, None]:
...
class Logger:
    ...
    def __init__(self, standard_logger: logging.Logger, context_filter: Optional[ContextFilter] = None) -> None:
        """Initialize logger."""
    ...
    def log_operation(self, operation: str, status: str = "started", **details: Any) -> None:
        """Log operation event."""
...
class LoggerFactory:
    ...
    def _setup_console_logging(cls, root_logger: logging.Logger, formatter: logging.Formatter) -> None:
        ...
        try:
            ...
            console_level = cast(str, DEFAULT_CONFIG.get('logging.console_level', 'INFO'))
